...
<!-- 
              ...
              <tr>
               ...
               <c:forEach items="${pageSupport.result}" var="User">
                 ...
                 <tr align="center">
                    ...
                    <td bgcolor="#FFFFFF">  <a href="UserDetail.action?type=${type}&id=${User.id}" onclick="return del()">修改|<a href="">冻结资金</a></a>
    	...
    	<tr>
    		<td align="right" width="50%">
    			<c:choose>
    	<c:when test="${pageSupport.startPage!=1}"><a href="JiedanUsers.action?type=${type}&pageNo=${pageSupport.prePage}">上一页</a></c:when>	
    	</c:choose></td>
    	<td width="50%" align="left"> 
    	<c:choose><c:when test="${pageSupport.nextPage<=pageSupport.totalPages}"><a href="JiedanUsers.action?type=${type}&pageNo=${pageSupport.nextPage}">下一页</a></c:when>
    	</c:choose>
    	</td>
    	</tr>
    	</table>  
